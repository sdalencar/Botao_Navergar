 ...
 * made by sda
 */
public class CargoAtualizaActivity extends AppCompatActivity {

    private EditText txtnome;
    private AlertDialog alerta;
    private Button bt_direita, bt_esquerda;
    private int id = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cargo_atualiza_activity);
    ...
    private void iniciarComponentes() {
        ...
        txtnome = (EditText) findViewById(R.id.et_cargo_atualiza_nome);
        bt_direita = findViewById(R.id.bts_direita);
        bt_esquerda = findViewById(R.id.bts_esquerda);

        txtnome.setText(snome);
        bt_direita.setText(getResources().getString(R.string.atualizar));
        bt_esquerda.setText(getResources().getString(R.string.apagar));
