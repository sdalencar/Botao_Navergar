 ...
 * made by sda
 */
public class ValePagoAtualizaActivity extends AppCompatActivity {
    ...
    private void iniciaComponentes() {
        ...
        adapterNomeSpinner = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, nomes);
        adapterRelacaoSpinner = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, relacoes);
    ...
    private void atualizar(int id, String iden, String nome, String rel, double valor) {
        ValePagoDao db = new ValePagoDao(ctx);
        db.openDB();
